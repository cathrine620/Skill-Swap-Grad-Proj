...
<table id="u_content_heading_1" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <!--[if mso]><table role="presentation" width="100%"><tr><td><![endif]-->
    <h1 class="v-line-height v-font-size" style="margin: 0px; line-height: 130%; text-align: center; word-wrap: break-word; font-family: 'Playfair Display',serif; font-size: 36px; font-weight: 400;"><span data-metadata="&lt;!--(figmeta)eyJmaWxlS2V5IjoiMHNRUkxSOGNyUFhMbVJGdjFocm1FTCIsInBhc3RlSUQiOjU1Mjc3NjAyOCwiZGF0YVR5cGUiOiJzY2VuZSJ9Cg==(/figmeta)--&gt;" style="line-height: 31.2px;"></span>Here's your new confirmation link for Skill Swap App .</h1>
  <!--[if mso]></td></tr></table><![endif]-->
...
<body>
  <div class="container" role="main" aria-label="OTP Verification Email">
    ...
    <div class="footer">
      &copy; Skill Swap . All rights reserved.
    </div>
  </div>
</body>
</html>
...
export const sendActivationCodeTemplate = (userName, code) => {
  return `
  <!DOCTYPE html>
<html lang="en" style="margin:0; padding:0;">
<head>
...
<body>
  <div class="container" role="main" aria-label="Account Activation Email">
    <h1>Welcome, ${userName || "User"}!</h1>
    <p>Thank you for registering with Skill Swap. Please use the One-Time Password (OTP) below to activate your account:</p>
    <div class="otp-code" aria-label="Your activation code is ">${code}</div>
    <p>This code is valid for 15 minutes.</p>
    <p>If you did not register, please ignore this email.</p>
    <p>Thank you,<br />The Skill Swap Team</p>
    <div class="footer">
      &copy; Skill Swap. All rights reserved.
    </div>
  </div>
